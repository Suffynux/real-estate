...
const Quality = () => {
  ...
  return <>
    ...
    <div className="px-[19px]">
      ...
      <h1 className="text-[24px] font-medium">What Make Us <span> <br />Different?</span>
</h1>
      <p className="pt-[14px] py-7 text-[#C4C4C4]">Check out our best service you can possibly orders in building your company and don't forget to ask via our email or our customer service if you are interested in using our services</p>
    </div>
    <div className="text-center flex flex-col justify-center align-center px-[63px] md:flex-row">
        {qualityitems.map((item , index)=>{
            return (
                <div key={index} className="flex flex-col justify-center items-center ">
                    <img src={item.src} alt={item.alt} className="w-[93px] py-[15px]" height={94}/>
    ...
    <div className="p-5">
        ...
        {/* profile Box */}
        <div className={`${styles.navbarGradient} h-[250px] w-[250px] relative top-24 flex flex-col justify-center items-center text-center p-4 gap-2 text-white`}>
        <img src="/profile.png" alt="Profile image" width={70} height={70} className="rounded-lg"/>
        <h1 className="text-[20px] font-medium">Dianne Russell</h1>
        <p className="text-[14px]">More than 20 years of experience in the fieldarchitecture and has
worked on project up to 100+</p>
    ...
    <section>
            ...
            <h1 className='text-[#242527] font-medium p-1 text-[24px] '>Meet and talk with <br />
our best architecture</h1>
            <p className='text-[#C4C4C4] text-[14px]'>All our teams are professional and competent in their fields and will help you realize your dream building with the excellent result.</p>
